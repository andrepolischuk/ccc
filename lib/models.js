...
module.exports.rgb.format = function(alpha) {
  return alpha ? 'rgba(%s, %s, %s, %s)' : 'rgb(%s, %s, %s)';
};
...
module.exports.hsl.format = function(alpha) {
  return alpha ? 'hsla(%s, %s%, %s%, %s)' : 'hsl(%s, %s%, %s%)';
};
...
module.exports.hsv.format = function(alpha) {
  return alpha ? 'hsva(%s, %s%, %s%, %s)' : 'hsv(%s, %s%, %s%)';
};
